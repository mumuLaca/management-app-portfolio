...
type Props = {
  ...
  mutateDailyReport: KeyedMutator<TypeMonthlyDailyReport>;
};
...
export default function AllEntry({
  ...
  const handleAllEntry = async () => {
    ...
    const enteredDates = dailyReportData.list.map((item) =>
    ...
    await axios.post("/api/daily/entry", data).then(() => mutateDailyReport());
  };
                ...
                <Row className="align-items-center pb-2">
                  ...
                  <Col xs={12} sm={6} md={12} lg={4} xl={4}>
                    ...
                    <div className="d-flex justify-content-end">
                      ...
                      <Button
                        disabled={!dailyReportData?.list?.length}
                        variant={
                          dailyReportData?.list?.length ? "dark" : "secondary"
                        }
